                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-md-7 col-lg-12">
                                ...
                                <form action="{{ route('conversions-report.store') }}" method="post" >
                                    @csrf
                                    <div class="report-row row g-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" id="restriction" name="restriction">
                                                ...
                                                <option value="1">Mayor cantidad de residuos reciclados</option>
                                                <option value="2">Mayor cantidad de conversiones por tipo de reciclaje</option>
                                                <option value="3">Por rango de fechas</option>
                                                <option value="4">Por empleado</option>
                                            </select>
                                        </div>
                                        <div id="dates">
                                            <div class="col-sm-6">
                            ...
                            @if ($conversions)
                                @include('conversions-reports.table')
                            @endif
